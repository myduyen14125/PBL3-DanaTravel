...
namespace PBL3.View.homepage
{
    public partial class FormHistoryTransaction : Form
    {
        ...
        private void ShowData()
        {
            ...
            {
                tourTickets = TourTicketBUS.Instance.GetTourTicketsByAccount(account_id, 1, 0);
            ...
            {
                tourTickets = TourTicketBUS.Instance.GetTourTicketsByAccount(account_id, 2, 1);
            ...
            {
                tourTickets = TourTicketBUS.Instance.GetTourTicketsByAccount(account_id, 2, 2);
            ...
            {
                tourTickets = TourTicketBUS.Instance.GetTourTicketsByAccount(account_id, 3, 0);
