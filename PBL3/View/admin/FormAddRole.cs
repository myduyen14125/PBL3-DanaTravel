...
namespace PBL3.View.admin
{
    public partial class FormAddRole : Form
    {
        ...
        {
            dataGridViewPermission.DataSource = RoleBUS.Instance.GetDataTablePermission();
        ...
        private void btnCreateRole_Click(object sender, EventArgs e)
        {
            ...
            foreach(DataGridViewRow r in dataGridViewPermission.Rows)
            {
                ...
                {
                    permissions.Add(RoleBUS.Instance.GetPermissionById(Convert.ToInt32(r.Cells["ID"].Value.ToString())));
                }
            }
            Role role = new Role
            {
