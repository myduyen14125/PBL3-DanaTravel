...
namespace PBL3.View.statistics
{
    public partial class Statistic : UserControl
    {
        ...
        private void DrawChartSale(int monthFrom, int monthTo, int year)
        {
            ...
            List<Revenue> revenues = StatisticBLL.Instance.GetRevenues(monthFrom, monthTo, year);
            int i = 0;
        ...
        {
            List<Revenue> revenues = StatisticBLL.Instance.GetRevenuesTourOutStanding(monthFrom, monthTo, year);
